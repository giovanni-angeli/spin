...
def start_three():
    a = Example([('bind', 'tcp://127.0.0.1:9990'), 'a', ('connect', 'tcp://127.0.0.1:9991')], 100*1000*'AAA_')
    b = Example([('bind', 'tcp://127.0.0.1:9991'), 'b', ('connect', 'tcp://127.0.0.1:9992')], 100*1000*'BBB_')
    c = Example([('bind', 'tcp://127.0.0.1:9992'), 'c', ('connect', 'tcp://127.0.0.1:9990')], 100*1000*'CCC_')
    import spin.utils
    spin.utils.set_asyncio_loop_in_inputhook()
    return a, b, c
